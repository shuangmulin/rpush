...
import com.regent.rpush.dto.message.dingtalk.corp.ActionCardMultiMessageDTO;
import com.regent.rpush.dto.message.dingtalk.corp.BtnJsonDTO;
 ...
 **/
@Component
public class CorpActionCardMultiMessageHandler extends MessageHandler<ActionCardMultiMessageDTO> {

    private final static Logger LOGGER = LoggerFactory.getLogger(CorpActionCardMultiMessageHandler.class);
    ...
    public MessageType messageType() {
        return MessageType.DING_TALK_COPR_ACTION_CARD_MULTI;
    }
