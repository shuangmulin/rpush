 ...
 **/
@Component
public class ActionCardSingleMessageHandler extends MessageHandler<ActionCardSingleMessageDTO> {

    private final static Logger LOGGER = LoggerFactory.getLogger(ActionCardSingleMessageHandler.class);
    ...
    public MessageType messageType() {
        return MessageType.DING_TALK_ROBOT_ACTION_CARD_SINGLE;
    }
