...
import com.regent.rpush.dto.message.dingtalk.robot.LinkMessageDTO;
 ...
 **/
@Component
public class RobotLinkMessageHandler extends MessageHandler<LinkMessageDTO> {

    private final static Logger LOGGER = LoggerFactory.getLogger(RobotLinkMessageHandler.class);
    ...
    public MessageType messageType() {
        return MessageType.DING_TALK_ROBOT_LINK;
    }
