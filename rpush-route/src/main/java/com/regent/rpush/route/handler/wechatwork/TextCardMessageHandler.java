...
import com.regent.rpush.dto.message.wechatwork.TextCardMessageDTO;
 ...
 *
 * @author 钟宝林
 * @since 2021/4/8/008 22:11
 **/
@Component
public class TextCardMessageHandler extends MessageHandler<TextCardMessageDTO> {

    private final static Logger LOGGER = LoggerFactory.getLogger(TextCardMessageHandler.class);
    ...
    public MessageType messageType() {
        return MessageType.WECHAT_WORK_TEXTCARD;
    }
