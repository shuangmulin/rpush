...
import com.regent.rpush.dto.message.wechatwork.robot.MarkdownMessageDTO;
...
public class MarkdownMessageHandler extends MessageHandler<MarkdownMessageDTO> {
    ...
    public MessageType messageType() {
        return MessageType.WECHAT_WORK_ROBOT_MARKDOWN;
    }
    ...
    public void handle(MarkdownMessageDTO param) {
        ...
        for (WechatWorkRobotConfig config : configs) {
            ...
            try {
                ...
                messageParam.put("msgtype", "markdown");
                messageParam.put("markdown", jsonObject);
