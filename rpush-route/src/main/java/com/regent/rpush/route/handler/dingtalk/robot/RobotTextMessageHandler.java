...
import com.regent.rpush.dto.message.dingtalk.robot.TextMessageDTO;
 ...
 **/
@Component
public class RobotTextMessageHandler extends MessageHandler<TextMessageDTO> {

    private final static Logger LOGGER = LoggerFactory.getLogger(RobotTextMessageHandler.class);
    ...
    public MessageType messageType() {
        return MessageType.DING_TALK_ROBOT_TEXT;
    }
