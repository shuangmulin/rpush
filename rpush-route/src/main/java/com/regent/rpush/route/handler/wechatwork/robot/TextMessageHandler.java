 ...
 **/
@Component
public class TextMessageHandler extends MessageHandler<TextMessageDTO> {

    private final static Logger LOGGER = LoggerFactory.getLogger(TextMessageHandler.class);
    ...
    public MessageType messageType() {
        return MessageType.WECHAT_WORK_ROBOT_TEXT;
    }
    ...
    public void handle(TextMessageDTO param) {
        ...
        for (WechatWorkRobotConfig config : configs) {
            ...
            try {
                ...
                messageParam.put("msgtype", "text");
                messageParam.put("text", jsonObject);
