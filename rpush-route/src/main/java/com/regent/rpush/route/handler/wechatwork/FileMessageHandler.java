 ...
 **/
@Component
public class FileMessageHandler extends MessageHandler<MediaMessageDTO> {

    private final static Logger LOGGER = LoggerFactory.getLogger(FileMessageHandler.class);
    ...
    public MessageType messageType() {
        return MessageType.WECHAT_WORK_FILE;
    }
